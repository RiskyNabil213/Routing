...
export const blogPosts: BlogPost[] = [
   {
     id: 1,
     title: "Nextjs-basics-css-Tailwind",
     slug: "nextjs-basics-css-tailwind",
     date: "2024-03-15",
   ...
   {
     id: 3,
     title: "React Markdown Error Solution",
     slug: "react-markdown-error-solution",
     date: "2024-04-01",
     excerpt: "How to fix common errors with react-markdown in your Next.js project.",
     content: `
     If you encounter errors with react-markdown, make sure you have installed the correct version and imported it properly.
     `,
     category: "React"
   },
   {
     ...
     date: "2024-04-05",
     excerpt: "Boost your productivity with these TypeScript tips.",
     content: `
     TypeScript can help you write safer and more maintainable code. Here are some tips to get the most out of it.
     `,
     category: "TypeScript"
   }
];